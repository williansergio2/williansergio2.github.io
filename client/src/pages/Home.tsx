...
>
  ...
  <Link href="/contato" className="hover:text-orange-500 transition">Contato</Link>
    ...
    >
      ...
      {/* Hero Section */}
<section
  className="relative pt-32 sm:pt-40 pb-20 overflow-hidden bg-cover bg-center"
  style={{
    backgroundImage: "url('/images/bg-manus.png')",
  }}
>

  {/* Overlay suave apenas para melhorar leitura */}
  ...
  <div className="container relative z-20">
    <div className="max-w-3xl mx-auto text-center space-y-6 animate-fade-in">
      ...
      <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
        Manutenção, upgrade e montagem de PCs com expertise técnica.
        Atendimento a domicílio em toda a região de Carapicuíba e cidades próximas.
      </p>
