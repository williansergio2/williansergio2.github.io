  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-20 container text-center space-y-6">
        <h2 className="text-4xl font-bold">Pagina em Desenvolvimento</h2>
        <p className="text-muted-foreground">
          Sobre nós ainda em desolvimento para voces poder conhecer um pouco da minha historia e experiência no ramo de computadores.
        </p>
      </section>
